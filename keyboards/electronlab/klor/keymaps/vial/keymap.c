...
#ifdef NEVER____DYNAMIC_MACRO_ENABLE
...
void matrix_scan_user(void) {
  #ifdef NEVER________________________________________________________________DYNAMIC_MACRO_ENABLE
    // DynMacroTimer
    if(dmacro_num > 0){
...
bool oled_task_kb(void) {
    ...
    if (is_keyboard_master()) {  // ────────────────────────── PRIMARY SIDE
        ...
        // layer status ──────────────────────────────────────────────────┐
        #ifdef NEVER_____________________________________________DYNAMIC_MACRO_ENABLE
