...
LAYOUT(
    ...
    LM(1, MOD_LCTL),   KC_A,   KC_S,    KC_D,    KC_F,    KC_G,                       KC_H,     KC_J,     KC_K,    KC_L,    KC_SCLN, KC_QUOT,
    KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,    QK_BOOT,   KC_MPLY,KC_N,     KC_M,     KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
                      KC_LCTL, KC_LGUI, KC_LCMD, KC_LALT, LM(1, MOD_LCTL),    KC_SPC, KC_RALT,  KC_RCMD,  KC_RGUI, KC_RCTL
)
};
